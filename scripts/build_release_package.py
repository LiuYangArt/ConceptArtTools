...
PACKAGE_ID = "concept_art_tools"

ROOT_FILES = (
    "__init__.py",
    "auto_load.py",
    "blender_manifest.toml",
    "AssetBrowserTools.py",
    "AssetCreation.py",
    "ConceptTools.py",
    "FindUsers.py",
    "IsolateMeshGroup.py",
...
def build_package(output_dir: Path, release_tag: str | None = None) -> Path:
    version = assert_version_matches_release_tag(release_tag)
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build the Concept Art Tools release zip.")
